			...
			angular.forEach(restos, function(resto, key1) {
				...
				****************************************************************************************/
				...
				if (compteurRestos%2==0) {
					angular.element(document.getElementById('restos-container')).append("<div class='row responsive-sm' id="+rowRestoId+"><div class='col col-50'><div class='card'><div class='item item-text-wrap'><img src="+resto.picture+" alt="+resto.name+"></div><div class='item item-divider text-center' style=background-color:"+resto.color+">"+resto.name+"</div></div>");
				} 
				// si le compteur est IMPAIRE on ajoute seulement l'ensemble du html pour représenter une card de resto
					...
					angular.element(document.getElementById(previousRowRestoId)).append("<div class='col col-50'><div class='card'><div class='item item-text-wrap'><img src="+resto.picture+" alt="+resto.name+"></div><div class='item item-divider text-center' style=background-color:"+resto.color+">"+resto.name+"</div>");
				};
				...
				****************************************************************************************/
			 		...
			 		if (compteurMenus%2==0) {
						angular.element(document.getElementById('menus-container')).append("<div class='row responsive-sm' id="+rowMenuId+"><div class='col col-50'><div class='card'><div class='item item-text-wrap'><span>"+menu.price+" €</span><img src="+menu.picture+" alt="+menu.name+"></div><div class='item item-divider text-center' style=background-color:"+resto.color+">"+menu.name+"</div></div>");
					} 
					// si le compteur est IMPAIRE on ajoute seulement l'ensemble du html pour représenter une card de menu
						...
						angular.element(document.getElementById(previousRowMenuId)).append("<div class='col col-50'><div class='card'><div class='item item-text-wrap'><span>"+menu.price+" €</span><img src="+menu.picture+" alt="+menu.name+"></div><div class='item item-divider text-center' style=background-color:"+resto.color+">"+menu.name+"</div>");
					};
